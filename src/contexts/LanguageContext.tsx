...
const translations = {
  pt: {
    ...
    // Store
    'store.title': 'Loja Exclusiva',
    'store.subtitle': 'Produtos selecionados para o seu tratamento',
    'store.learnMore': 'Saiba Mais',
    'store.exclusive': 'Exclusivo',
    'store.discount': 'DESCONTO',
    'store.recommended': 'Recomendado',
    'store.rating': 'avaliações',
    ...
    'education.tutorialDesc': 'Assista ao vídeo acima para aprender como usar seu dispositivo IPL de forma eficaz e segura.',
    ...
    'about.version': 'Taqcare | Versão 1.4',
  ...
  en: {
    ...
    // Store
    'store.title': 'Exclusive Store',
    'store.subtitle': 'Selected products for your treatment',
    'store.learnMore': 'Learn More',
    ...
    'education.tutorialDesc': 'Watch the video above to learn how to use your IPL device effectively and safely.',
    ...
    'about.version': 'Taqcare | Version 1.4',
