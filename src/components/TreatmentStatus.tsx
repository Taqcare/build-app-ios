    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        if (sessions && sessions.length > 0) {
          ...
          // If no scheduled session but some completed, suggest a date 4 weeks from today
          const suggestedDate = addDays(new Date(), 28);
          nextSessionDate = `Sugestão: ${format(suggestedDate, "dd 'de' MMMM, yyyy", { locale: ptBR })}`;
          recommendedTime = "Agende sua próxima sessão";
        }
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-primary">{treatmentData.sessions}/{treatmentData.totalSessions} Sessões</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-primary-light dark:bg-gray-700 p-4 rounded-lg">
            ...
            <div className="mt-4">
              <h4 className="text-sm font-medium mb-2 text-gray-900 dark:text-white">Dicas</h4>
              <ul className="text-sm text-gray-600 dark:text-gray-300 list-disc pl-5 space-y-1">
                <li>Raspe a área 24 horas antes do tratamento</li>
                <li>Use protetor solar FPS 30+ por duas semanas após o tratamento</li>
                <li>Evite banhos quentes por 48 horas após o tratamento</li>
              </ul>
            </div>
          </div>
        </div>
