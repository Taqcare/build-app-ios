...
const IntroSplash = ({ onComplete }: IntroSplashProps) => {
  ...
  return (
    <motion.div 
      className="fixed inset-0 bg-[#FE7E8D] flex flex-col items-center justify-center z-50"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      <div className="flex flex-col items-center justify-center h-full w-full">
        ...
        >
          <img 
            src="/lovable-uploads/aff2442b-0e69-4422-a538-2632e8bc4458.png" 
            alt="Taqcare Logo" 
            className="w-32 h-32"
          />
        </motion.div>
        ...
        <motion.div
          className="mb-12 text-white text-center w-full"
